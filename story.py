...
هنا ظهرت مهارات {child_name} في القيادة.
لم يغضب، بل وزع المهام بعدل، وشجع الجميع بالكلمة الطيبة.
استخدموا {value} ليتجاوزوا الخلافات بينهم.
وبفضل حكمة {child_name}، عاد الفريق بسلام وهم أكثر قوة وصداقة.
"""
        },
        "10-12": {
...
وقف {child_name} أمام خيار صعب: السكوت والعيش في أمان، أو التحدث وتعريض نفسه للخطر.
بدأ {child_name} رحلة طويلة للبحث عن الحقيقة، واجه فيها الهاكرز والأشرار.
استخدم ذكاءه ومهاراته في البرمجة، والأهم من ذلك: تمسكه بـ {value}.
بعد مغامرات مثيرة ومواقف صعبة، نجح {child_name} في تغيير النظام وتحقيق العدالة.
أصبح {child_name} رمزاً للشجاعة والتغيير في مجتمعه.
"""
        },
        "default": {
             "style": "عام.",
